...
ansiColor('xterm') {
   node('rzdockeruat') {
       ...
       sh 'curl -XPOST -H "Authorization: token 72b08912bdfaffdafa9b3e44b540011fad7372b6" https://api.github.com/repos/:organization/:repos/statuses/$(git rev-parse HEAD) -d "{
  \"state\": \"success\",
